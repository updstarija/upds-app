...
export const DetalleMateriaV2: React.FC<Props> = memo(
  ({ materia: plan, view }) => {
                ...
                <View className="rounded-2xl bg-[#223B82] p-5 dark:bg-[#0D1F46]">
                  ...
                  <View className="flex gap-y-2">
                    <View className="flex-row justify-evenly">
                      <Etiqueta
                        color="#006DFF"
                        label={`Estrategico (85-100) ${
                          data.data?.data.distribucionNotas.find(
          ...
          `}
                  ...
                  {isValidMateria && (
                    <>
                      <View
                        style={{
                          borderBottomColor: etiquetas[plan.estado.id].color,
                          borderRightWidth: 25,
                      ...
                      >
                        <FontAwesome
                          name={etiquetas[plan.estado.id].icon}
                          color={"#FFF"}
                        />
                      </View>
                    </>
