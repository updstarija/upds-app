...
`;
  return (
    <ScrollView className="bg-white dark:bg-primario-dark flex-1">
      <View className="p-4">
        <Texto className="dark:text-white text-3xl mb-4" weight="Bold">
          UPDS TARIJA
        </Texto>

        <Texto className="dark:text-white text-sm">Versión</Texto>

        <Texto className="mb-4 dark:text-white">
          {nativeApplicationVersion}
        </Texto>
        <Texto className="dark:text-white text-sm">
          Upds Tarija es una aplicación oficial de la Universidad Privada
          Domingo Savio Sede Tarija. Esta aplicación está diseñada para
          simplificar la vida académica de los estudiantes, permitiendo
          programar materias, recibir notificaciones importantes, acceder a la
          boleta de proyección y consultar el registro histórico académico.
        </Texto>

        <Texto className="dark:text-white text-xl mt-8 mb-2" weight="Bold">
          Equipo de Desarrollo
        </Texto>
        <Texto className="dark:text-white text-sm">
          El equipo de desarrollo está compuesto por miembros del Departamento
          de Sistemas de la UPDS.
        </Texto>
        ...
        <View className="flex items-center p-2">
          ...
          <Texto
            ...
            onPress={() => Linking.openURL("mailto:danteariastarifa@gmail.com")}
          >
        ...
        <Texto className="dark:text-white text-sm mt-8">
          Para asistencia técnica o preguntas relacionadas con la aplicación, no
          dudes en contactar al Departamento de Sistemas de la Universidad
        ...
        <Texto className="dark:text-white text-sm mt-2">
          ...
          <Texto
            className="dark:text-white text-blue-500"
            onPress={() => Linking.openURL("mailto:soporte.tarija@upds.edu.do")}
          >
            soporte.tarija@upds.edu.bo
          </Texto>
        </Texto>
        <Texto className="dark:text-white text-sm mt-2">
