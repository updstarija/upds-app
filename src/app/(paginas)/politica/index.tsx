...
<p><strong>a. Utilizamos la información recopilada para brindar servicios relacionados con su experiencia académica en la Universidad Privada Domingo Savio, como la programación de materias, la generación de la boleta de proyección y la visualización del registro histórico.</strong></p>
<p><strong>b. También utilizamos la información para enviar notificaciones relevantes relacionadas con sus actividades académicas y administrativas.</strong></p>

<h2>4. Compartir Información</h2>
<p>No compartimos su información personal con terceros, excepto en las siguientes circunstancias:</p>
<p><strong>a. Cuando sea necesario para cumplir con las obligaciones académicas y administrativas de la universidad.</strong></p>
<p><strong>b. Cuando sea requerido por la ley o las autoridades gubernamentales.</strong></p>
<p><strong>c. Con su consentimiento previo y expreso.</strong></p>

<h2>5. Seguridad de Datos</h2>
<p><strong>a. Implementamos medidas de seguridad razonables para proteger la información personal que recopilamos.</strong></p>
<p><strong>b. No obstante, tenga en cuenta que ninguna transmisión de datos por Internet o sistema de almacenamiento de datos es 100% seguro. No podemos garantizar la seguridad de la información transmitida a través de la Aplicación.</strong></p>
